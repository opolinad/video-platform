...
module.exports = {
  up: async (queryInterface: QueryInterface): Promise<object | number> => {
    return queryInterface.bulkInsert('video', [
      {
        title: 'Video1',
        url: 'https://www.youtube.com/watch?v=c2OEtrdb5VI',
      ...
      {
        title: 'Video2',
        url: 'https://www.youtube.com/watch?v=ATHgQC0QZ0o',
      ...
      {
        title: 'Video3',
        url: 'https://www.youtube.com/watch?v=7voIt1TQY6E',
      ...
      {
        title: 'Video4',
        url: 'https://www.youtube.com/watch?v=JDkybaU-90s',
      ...
      {
        title: 'Video6',
        url: 'https://www.youtube.com/watch?v=lXHacHtSKxg',
      ...
      {
        title: 'Video8',
        url: 'https://www.youtube.com/watch?v=7kHg0BU9tCo',
